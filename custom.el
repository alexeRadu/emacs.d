(custom-set-variables
 ...
 '(package-selected-packages
   '(realgud xah-fly-keys origami doom-themes zenburn-theme evil-magit fill-column-indicator evil magit svg company counsel-gtags ggtags neotree avy counsel swiper projectile org-bullets use-package)))
(custom-set-faces
